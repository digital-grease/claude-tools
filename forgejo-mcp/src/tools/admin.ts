...
export function registerAdminTools(server: McpServer, client: ForgejoClient) {
  registerActionTool(server, client, "forgejo_admin", "Forgejo admin and miscellaneous operations (requires admin token)", {
    list_users: {
    ...
    version: {
      description: "Get Forgejo version",
