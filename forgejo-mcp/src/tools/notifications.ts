...
export function registerNotificationTools(server: McpServer, client: ForgejoClient) {
  registerActionTool(server, client, "forgejo_notifications", "Manage Forgejo notifications", {
    list: {
