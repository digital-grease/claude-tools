...
export function registerUserTools(server: McpServer, client: ForgejoClient) {
  registerActionTool(server, client, "forgejo_users", "Query Forgejo users and the authenticated user", {
    me: {
